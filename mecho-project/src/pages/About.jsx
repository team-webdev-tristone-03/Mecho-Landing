  ...
  useEffect(() => {
    ...
    const animateSlider = () => {
      ...
      if (slider) {
        setTimeout(() => {
          // Move to left (10%)
          slider.style.setProperty('--position', '10%');
          setTimeout(() => {
            // Move to right (90%)
            slider.style.setProperty('--position', '90%');
            setTimeout(() => {
              // Return to center (50%)
        ...
        <div className="container">
          <div className="hero-content">
            <div className="hero-text">
              ...
              <p>
                MECHO is your trusted partner for premium automotive services. We combine cutting-edge waterless cleaning technology with expert mechanical support to deliver unmatched convenience and quality.
              </p>
            ...
            <div className="hero-visual">
              <div className="img-comparison-container">
                <ImgComparisonSlider>
                  <img slot="first" src={Dusty} alt="Before - Dusty car" className="comparison-img" />
                  <img slot="second" src={Clean} alt="After - Clean car" className="comparison-img" />
                </ImgComparisonSlider>
              </div>
            </div>
          </div>
      ...
      <section className="mecho-features" ref={featuresRef}>
        <div className="container">
          <div className="section-header">
            <h2>What We Do</h2>
            <p>Premium 15-Minute Waterless Car Wash</p>
          </div>
        ...
        <div className="container">
          <div className="vm-grid">
            <div className="vm-card vision-card">
              ...
              <h3>Our Vision</h3>
              <p>
                To become the most trusted on-demand automotive care service, delivering premium, eco-friendly cleaning and mechanic support anywhere, anytime.
              </p>
            </div>
            <div className="vm-card mission-card">
              ...
              <h3>Our Mission</h3>
              <p>
                To provide fast, affordable, waterless car cleaning and reliable mechanical support using innovation, mobility, and sustainable cleaning technology.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="ceo-content">
            ...
            <div className="ceo-text">
              ...
              <p>
                With over a decade of experience in the automotive industry, Rahul founded MECHO with a vision to revolutionize car care through sustainable innovation. His expertise in both mechanical services and eco-friendly technologies has positioned MECHO as a leader in waterless car cleaning solutions.
              </p>
              <p>
                Under his leadership, MECHO has grown from a local startup to a trusted brand, serving thousands of customers while maintaining our commitment to environmental sustainability and exceptional service quality.
              </p>
            </div>
          </div>
        </div>
